...
public struct AniStateData : IFlatbufferObject
{
  ...
  public Ivaldi.FlatBuffers.AnimatorData.AniEventData? Events(int j) { int o = __p.__offset(26); return o != 0 ? (Ivaldi.FlatBuffers.AnimatorData.AniEventData?)(new Ivaldi.FlatBuffers.AnimatorData.AniEventData()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int EventsLength { get { int o = __p.__offset(26); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<Ivaldi.FlatBuffers.AnimatorData.AniStateData> CreateAniStateData(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateEventsVector(FlatBufferBuilder builder, Offset<Ivaldi.FlatBuffers.AnimatorData.AniEventData>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateEventsVectorBlock(FlatBufferBuilder builder, Offset<Ivaldi.FlatBuffers.AnimatorData.AniEventData>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEventsVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<Ivaldi.FlatBuffers.AnimatorData.AniEventData>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEventsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<Ivaldi.FlatBuffers.AnimatorData.AniEventData>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartEventsVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<Ivaldi.FlatBuffers.AnimatorData.AniStateData> EndAniStateData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Ivaldi.FlatBuffers.AnimatorData.AniStateData>(o);
  }
}
...
static public class AniStateDataVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfTables(tablePos, 26 /*Events*/, Ivaldi.FlatBuffers.AnimatorData.AniEventDataVerify.Verify, false)
